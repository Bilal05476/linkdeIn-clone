...
const UserDetails = () => {
  ...
  return (
    <>
      {toggleTheme && (
        <div className="userDetailsLight">
          <img
            className="cover"
          ...
          <div className="userInfo">
            ...
            <p className="userAboutLight mb-0">
              {!userOccupation
          ...
          <div className="profileAnalytics">
            <div className="profileViewsLight">
              <p className="mb-0">Who viewed your profile</p>
              <strong>128</strong>
            </div>
            <div className="postViewsLight">
          ...
          <div
            ...
            className="myItemsLight pl-3 py-3 d-flex align-items-center"
          >
